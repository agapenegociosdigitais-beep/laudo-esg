#!/usr/bin/env python3
"""Corrigir senha do usuário agapenegociosdigitais@gmail.com"""
import paramiko
...
try:
    ...
    # Hash da senha 'sr 77840000' - versão com escaping para PostgreSQL
    # No PostgreSQL, $ precisa ser $$ para ser literal
    senha_hash = "$$2b$$12$$gWD.BPOpVgFU4m9IyPKguuqzJxuibiPbfdcj6Ko.lQ5NYuAZ95iAG"
    
    print("[*] Atualizando senha no PostgreSQL...")
    
    # Comando SQL
    sql = f"UPDATE usuarios SET senha_hash='{senha_hash}' WHERE email='agapenegociosdigitais@gmail.com';"
